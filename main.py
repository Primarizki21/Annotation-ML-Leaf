...
async def api_undo():
    ...
    return {
        ...
        "task_type": last["patch"].get("task_type"),
        "model_prediction": last["patch"].get("model_prediction"),
        "model_confidence": last["patch"].get("model_confidence"),
        "model_margin": last["patch"].get("model_margin"),
        "cluster_id": last["patch"].get("cluster_id"),
        "cluster_margin": last["patch"].get("cluster_margin"),
        "index": session["current_index"],
        "total": len(session["patch_list"]),
        "annotated_count": session["annotated_count"],
    }
